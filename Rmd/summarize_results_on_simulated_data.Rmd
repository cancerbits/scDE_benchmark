...
for (experiment in experiments) {
  ...
  res_list <- future_lapply(X = rds_files, FUN = function(f) {
    ...
    transformation_time = res$timing['transformation', 'user.self'] #dplyr::filter(res$timing, step == 'transformation')$time
    method_time = res$timing['de_method', 'user.self'] #dplyr::filter(res$timing, step == 'de_method')$time
