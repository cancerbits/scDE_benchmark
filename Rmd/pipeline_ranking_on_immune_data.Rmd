...
saveRDS(list(fr = fr, metrics_wide = metrics_wide), 
        file = file.path(config$out_root, 'results', 'immune_data_summarized', 'final_ranking_immune.Rds'))
```
...
ch <- res_heatmap(fr, metrics_wide, 
                  ...
                  fig_width = 4.5, fig_height = 3.5, show_values = FALSE, 
                  show_col_names = FALSE, anno_left_full = FALSE)
```
